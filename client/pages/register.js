...
export default function Home() {
  ...
  var data = [
    {
      id: "email",
      label: GetTranslateText("main.register.label.email"),
      alt: GetTranslateText("main.register.label.email.alt"),
      type: "text",
    ...
    {
      id: "displayName",
      label: GetTranslateText("main.register.label.displayName"),
      alt: GetTranslateText("main.register.label.displayName.alt"),
      type: "text",
    ...
    {
      id: "password",
      label: GetTranslateText("main.register.label.password"),
      alt: GetTranslateText("main.register.label.password.alt"),
      type: "password",
      placeHolder: "",
      value: "",
      isValidate: false,
  ...
  const onSignup = () => {
    ...
    const displayName = data[1].value;
    const password = data[2].value;
    userSignup({ email, displayName, password }, true);
  };
    ...
    <AuthPage>
      <Head>
        <title>{`${GetTranslateText("app.name")} | ${GetTranslateText(
          "main.register.label.register.button"
        )}`}</title>
