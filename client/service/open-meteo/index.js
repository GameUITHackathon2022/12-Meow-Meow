import { GeocodingApi, AirQualityApi } from "../axios/config"
import dayjs from "dayjs"
import GetTranslateText from '../react-intl/GetTranslateText'

export async function getCity(value) {
    let res = {}
    res = await GeocodingApi
      .get('/search'+value)
      .then(({ data }) => {
        return data
        }
...
export async function getAirQuality(value) {
  let res = {}
  res = await AirQualityApi
