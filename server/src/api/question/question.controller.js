...
module.exports = {
	...
	deleteQuestion: async (req, res, next) => {
		try {
			let DTO = await questionService.deleteQuestion(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	modifyQuestion: async (req, res, next) => {
		try {
			let DTO = await questionService.modifyQuestion(
				req.user.id,
				req.params.id,
				req.body
			);
	...
	upVoteQuestion: async (req, res, next) => {
		try {
			let DTO = await questionService.upVoteQuestion(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	downVoteQuestion: async (req, res, next) => {
		try {
			let DTO = await questionService.downVoteQuestion(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	deleteReply: async (req, res, next) => {
		try {
			let DTO = await questionService.deleteReply(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	upVoteReply: async (req, res, next) => {
		try {
			let DTO = await questionService.upVoteReply(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	downVoteReply: async (req, res, next) => {
		try {
			let DTO = await questionService.downVoteReply(
				req.user.id,
				req.params.id
			);
			res.status(200).json(DTO);
	...
	addReply: async (req, res, next) => {
		try {
			let DTO = await questionService.addReply(
				req.user.id,
				req.params.id,
				req.body
			);
	...
	modifyReply: async (req, res, next) => {
		try {
			let DTO = await questionService.modifyReply(
				req.user.id,
				req.params.id,
				req.body
			);
	...
	getQuestionWithCategory: async (req, res, next) => {
		try {
			let DTO = await questionService.getQuestionWithCategory(
				req.params.category
			);
			res.status(200).json(DTO);
		} catch (error) {
